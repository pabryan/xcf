...
\newcommand{\edo}[1]{\mathcal{#1}}
\newcommand{\tpose}[1]{{#1}^T}
\newcommand{\adjt}[1]{{#1}^{\sharp}}
\newcommand{\adjg}[1]{\text{adjg}\> {#1}}
...
\DeclareMathOperator{\edoRic}{\mathcal{Ric}}
\DeclareMathOperator{\Rm}{Rm}
\DeclareMathOperator{\Sc}{R}
\DeclareMathOperator{\Ein}{G}
\DeclareMathOperator{\edoEin}{\mathcal{G}}
\DeclareMathOperator{\RicEin}{\Ric_{\Ein}}
\DeclareMathOperator{\edoRicEin}{\edoRic_{\edoEin}}
\DeclareMathOperator{\schouten}{P}
\DeclareMathOperator{\weyl}{W}
\DeclareMathOperator{\K}{K}
\DeclareMathOperator{\sK}{\rho}
\DeclareMathOperator{\psym}{\sigma}
\newcommand{\Trfree}[1]{\overset{\circ}{{#1}}}
\DeclareMathOperator{\edoTrfreeRic}{\Trfree{\edoRic}}
